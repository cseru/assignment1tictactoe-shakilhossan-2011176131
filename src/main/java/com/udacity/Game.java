...
public class Game {
    ...
    public String checkGameWinner(char [][]grid) {
        ...
        if((grid[0][0]== 'x' && grid[0][1]== 'x' && grid[0][2]== 'x') || (grid[1][0]== 'x' && grid[1][1]== 'x' && grid[1][2]== 'x') || (grid[2][0]== 'x' && grid[2][1]== 'x' && grid[1][2]== 'x') || (grid[2][0]== 'x' && grid[2][1]== 'x' && grid[2][2]== 'x') || (grid[0][0]== 'x' && grid[1][0]== 'x' && grid[2][0]== 'x') || (grid[0][1]== 'x' && grid[1][1]== 'x' && grid[2][1]== 'x') || (grid[0][2]== 'x' && grid[1][2]== 'x' grid[2][2]== 'x') ||(grid[0][0]== 'x' && grid[1][1]== 'x' && grid[2][2]== 'x') || (grid[0][0]== 'x' && grid[1][1]== 'x' && grid[2][2]== 'x') || (grid[2][0]== 'x' && grid[1][1]== 'x' && grid[0][2]== 'x'))
        {

            result = "X wins";
        }
       else if ((grid[0][0]== '0' && grid[0][1]== '0' && grid[0][2]== '0') || (grid[1][0]== '0' && grid[1][1]== '0' && grid[1][2]== '0') || (grid[2][0]== '0' && grid[2][1]== '0' && grid[1][2]== '0') || (grid[2][0]== '0' && grid[2][1]== '0' && grid[2][2]== '0') || (grid[0][0]== '0' && grid[1][0]== '0' && grid[2][0]== '0') || (grid[0][1]== '0' && grid[1][1]== '0' && grid[2][1]== '0') || (grid[0][2]== '0' && grid[1][2]== '0' grid[2][2]== '0' ) ||(grid[0][0]== '0' && grid[1][1]== '0' && grid[2][2]== '0') || (grid[0][0]== '0' && grid[1][1]== '0' && grid[2][2]== '0') || (grid[2][0]== '0' && grid[1][1]== '0' && grid[0][2]== '0'))
        {
            result = "0 wins";
        }
